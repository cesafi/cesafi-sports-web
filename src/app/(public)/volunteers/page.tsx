      ...
      <section className="relative min-h-[70vh] overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10 pt-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            {/* Subtitle */}
            <p className={`${roboto.className} text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div className={`${roboto.className} text-muted-foreground text-sm font-medium text-center`}>
                    {stat.label}
                  </div>
                </div>
              ))}
