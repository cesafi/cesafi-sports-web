...
interface WriterArticleFormProps {
...
export function WriterArticleForm({ onSubmit, isSubmitting, initialData, compact = false }: WriterArticleFormProps) {
    ...
    return (
      <Card className="w-full">
        ...
        <CardContent className="space-y-4">
          ...
          {/* Status - Writers cannot change this */}
          <div className="space-y-1.5">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-muted-foreground">
            Writers cannot change article status. This will be managed by editors.
          </p>
        </div>
